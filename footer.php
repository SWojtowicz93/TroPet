<div class = "footer_container">
  <div class = "footer_con">
    ...
    <a href="index.php"><img src="src/tropet4.png"></a> 
    </div>
    ...
    <div class = "footer_politic">
      <ul><h2>Polityka strony</h2>
        <li><a href="#">Polityka prywatności</a></li>     
        <li><a href="#">Polityka dotycząca plików cookie</a></li>
    ...
    <ul><h2>Kontakt</h2>
        <li> &#9993; tropet@gmail.com</li>     
        <li> &#9990; 55-554-442-223</li>
        <li> &#10084; We love animals</li>
      </ul>
    </div>
    </div>
  <div class = "footer_copyright">
   <b> TROPET - Odnajdź swojego pupila. Strona w sieci od 2022r. &copy; Wszelkie prawa zastrzeżone.</b>
  </div>
</div>