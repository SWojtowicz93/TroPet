...
// Sprawdzenie usposobieinia	
		...
		if(ctype_alnum($nature)==false)
		{
			$everything_OK = false;
			$_SESSION['e_nature'] = "usposobieinia może posiadać tylko litery (bez polskich znaków)";
		}
...
//Walidacja udała się na wszystkich danych
					$id = $_SESSION['id'];
					if($polaczenie->query("INSERT INTO pet VALUES(NULL, '$pet_name','$breed', '$size', '$color', '$nature', 1, $id)"))
					{
							$_SESSION['udane_dodanie'] = true;
							// header('Location: welcome.php');
							header('Location: pet_added.php');
					}
					else
					{
